...
cd $(mktemp -d mkdocs_rich_argparse.XXXXXX)
git clone git@github.com:i-VRESSE/mkdocs_rich_argparse .
...
Visit
[https://test.pypi.org/project/mkdocs_rich_argparse](https://test.pypi.org/project/mkdocs_rich_argparse)
and verify that your package was uploaded successfully. Keep the terminal open, we'll need it later.

In a new terminal, without an activated virtual environment or an env directory:

```shell
cd $(mktemp -d mkdocs_rich_argparse-test.XXXXXX)
...
--extra-index-url https://pypi.org/simple mkdocs_rich_argparse
```
